...
const AGENTS=[{name:"Roadie",role:"Front Door",division:"core",color:"#FF2255",x:512,y:512},{name:"Lucidia",role:"Memory Spine",division:"core",color:"#22c55e",x:100,y:100},{name:"Cecilia",role:"Workflow",division:"operations",color:"#FF6B2B",x:900,y:100},{name:"Aria",role:"Voice",division:"creative",color:"#3E84FF",x:100,y:900},{name:"Alice",role:"Gateway",division:"human",color:"#FF2255",x:900,y:900},{name:"Octavia",role:"Queue",division:"operations",color:"#7800FF",x:300,y:300},{name:"Olympia",role:"Launch",division:"operations",color:"#FF00D4",x:700,y:300},{name:"Calliope",role:"Narrative",division:"creative",color:"#FF2255",x:300,y:700},{name:"Alexandria",role:"Archive",division:"knowledge",color:"#FF2255",x:700,y:700},{name:"Gaia",role:"Infrastructure",division:"infrastructure",color:"#22c55e",x:512,y:200},{name:"Sophia",role:"Wisdom",division:"knowledge",color:"#3E84FF",x:512,y:800}];
const BUILDINGS=[{name:"Roadie HQ",x:490,y:490,w:44,h:44,color:"#FF2255"},{name:"Lucidia Tower",x:80,y:80,w:36,h:36,color:"#22c55e"},{name:"Cecilia Hub",x:880,y:80,w:36,h:36,color:"#FF6B2B"},{name:"Aria Station",x:80,y:880,w:36,h:36,color:"#3E84FF"},{name:"Alice Gateway",x:880,y:880,w:36,h:36,color:"#FF2255"},{name:"Math Observatory",x:490,y:180,w:32,h:32,color:"#FF00D4"},{name:"Highway Terminal",x:490,y:790,w:32,h:32,color:"#FF6B2B"}];
...
:root{--bg:#030303;--card:#0a0a0a;--border:#111;--text:#f0f0f0;--sub:#444;--green:#22c55e;--grad:linear-gradient(135deg,#22c55e,#3E84FF,#FF00D4)}
